...
class NotesServices extends ChangeNotifier {
  ...
  final String _privatekey =
      '0x83d8beddd5f24817926147868b8f5267bf4a78bb41627cf49485c1942093b773';
  ...
  try{
 const int gasLimit = 300000; // Gaz sınırını burada belirleyebilirsiniz
  ...
  await _web3cient.sendTransaction(
    ...
    Transaction.callContract(
      ...
      gasPrice: EtherAmount.inWei(BigInt.one), // Gaz fiyatı (isteğe bağlı)
      maxGas: gasLimit, // Gaz sınırı
    ),
  );
  isLoading = true;
  fetchNotes();
